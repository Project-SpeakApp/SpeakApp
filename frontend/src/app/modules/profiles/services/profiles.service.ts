...
export class ProfilesService {
  ...
  public getProfile(userId: string) {
    ...
    return this.http
      .get<ProfileGetDTO>(`https://localhost:8080/api/users/${userId}`)
      .pipe(
  ...
  public updateProfile(profile: ProfileUpdateDTO) {
    ...
    return this.http
      .put<ProfileGetDTO>(`https://localhost:8080/api/users`, profile, {
      })
      .pipe(
  ...
  public updateProfilePhoto(mediaId: string) {
    return this.http.put(`https://localhost:8080/api/users/profile-photo`, { photoId: mediaId }, {});
  }

  public updateBackgroundPhoto(mediaId: string) {
    return this.http.put(`https://localhost:8080/api/users/background-photo`, { photoId: mediaId }, {});
  }
}

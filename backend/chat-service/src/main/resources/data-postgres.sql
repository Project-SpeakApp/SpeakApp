...
VALUES (message_id_1, user_id_1, 'Bears are the best animals imo!', 'TEXT', conversation_id_1, null, message_timestamp_1, message_timestamp_1),
       ...
       (message_id_6, user_id_6, 'Are you crazy dude?', 'TEXT', conversation_id_1, message_id_3, message_timestamp_6, message_timestamp_6),
       ...
       (message_id_7, user_id_4, 'Ok, have a nice workout', 'TEXT', conversation_id_2, null, message_timestamp_7, message_timestamp_7),

       (message_id_8, user_id_1, 'Where are you?', 'TEXT', conversation_id_3, null, message_timestamp_1, message_timestamp_1),
       (message_id_9, user_id_2, 'Give me 5 minutes, I had to feed my bear...', 'TEXT', conversation_id_3, null, message_timestamp_2, message_timestamp_2),
       (message_id_10, user_id_1, 'Okay, I will get some beers for us then', 'TEXT', conversation_id_3, null, message_timestamp_3, message_timestamp_3),

       (message_id_11, user_id_6, 'Hey, do you want to go out sometimes?', 'TEXT', conversation_id_4, null, message_timestamp_3, message_timestamp_3),
       (message_id_12, user_id_3, 'No, btw I use arch', 'TEXT', conversation_id_4, null, message_timestamp_4, message_timestamp_4);
...
VALUES (message_reaction_id_1, message_id_1, user_id_2, reaction_timestamp_1, 'LOVE', 1),
       ...
       (message_reaction_id_4, message_id_6, user_id_3, reaction_timestamp_6, 'WRR', 1),
       (message_reaction_id_5, message_id_9, user_id_1, reaction_timestamp_2, 'HA_HA', 1),
       (message_reaction_id_6, message_id_12, user_id_6, reaction_timestamp_4, 'WOW', 1);
END
$$;
  ...
  <#elseif section="form">
    <@form.kw action=url.registrationAction method="post">
      ...
      <@input.kw
        ...
        invalid=messagesPerField.existsError("dateOfBirth")
        label=msg("dateOfBirth")
        message=kcSanitize(messagesPerField.get("dateOfBirth"))
        name="user.attributes.dateOfBirth"
        type="date"
        value=(register.formData['user.attributes.dateOfBirth'])!''
      />

...
$$
    ...
    BEGIN
        ...
        VALUES (user_id_1, 'John', 'Doe', 'johndoe@gmail.com', '1990-01-01'::date, '2023-01-01 12:00:00'::timestamp, 'Lorem ipsum dolor sit amet.', '', '2023-12-01'::date),
                (user_id_2, 'Alice', 'Johnson', 'alicejohnson@gmail.com', '1985-05-15'::date, '2023-02-01 12:00:00'::timestamp, 'Consectetur adipiscing elit.', '', '2023-12-11'::date),
                (user_id_3, 'Christopher', 'Bear', 'christopherbear@gmail.com', '1998-07-20'::date, '2023-03-01 12:00:00'::timestamp, 'Vivamus et justo nec purus.', '', '2023-12-09'::date);
